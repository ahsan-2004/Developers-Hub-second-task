...
import { 
  ...
  Bell, FileText, Settings, HelpCircle, CalendarDays, Video, CreditCard, ShieldCheck, Archive
} from 'lucide-react';
...
export const Sidebar: React.FC = () => {
  ...
  const entrepreneurItems = [
    ...
    { to: '/schedule', icon: <CalendarDays size={20} />, text: 'Schedule' },
    { to: '/video-call', icon: <Video size={20} />, text: 'Video Call' },
    { to: '/documents', icon: <FileText size={20} />, text: 'Documents' },
    { to: '/documents/chamber', icon: <Archive size={20} />, text: 'Document Chamber' },
